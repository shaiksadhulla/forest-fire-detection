...
def send_mail(n):
    ...
    email_address = 'gorlamadhu2001@gmail.com' # Specify the gmail account you want to send the email from
    password = 'zxbopvxaweaiurns' # Enter its password

    msg = EmailMessage()
    msg['Subject'] = 'FOREST FIRE ALERT !'
    msg['From'] = email_address
    msg['To'] = 'gorlamadhu2001@gmail.com' # Specifiy the receiver's email address
